...
def parse_arguments(notebook_options=None):
    ...
    parser.add_argument('--margin', default=1, type=float,
                        help='margin')
    parser.add_argument('--triplet', default=1, type=float,
                        help='triplet loss weight')
    parser.add_argument('--contrastive', default=1, type=float,
                        help='contrastive loss weight')
    parser.add_argument('--ce', default=1, type=float,
                        help='cross entropy loss weight')
    parser.add_argument('--triplet2', default=1, type=float,
                        help='triplet loss weight 2D')
    parser.add_argument('--contrastive2', default=1, type=float,
                        help='contrastive loss weight 2D')
    parser.add_argument('--ce2', default=1, type=float,
                        help='cross entropy loss weight 2D')
    #
    # Model arguments
    #
